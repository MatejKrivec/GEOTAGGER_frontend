    ...
    <div className="flex flex-col min-h-screen relative">
      ...
      <div className='overflow-y-auto m-5'>
        <div className='flex flex-col mb-[1rem]'>
          <h1 className='text-3xl mb-3 text-green-400'>Activity log</h1>
        </div>
        
        <div className='activityLogs flex flex-col items-center overflow-y-auto h-[31.25rem]'>
          <div className='LogsData grid grid-cols-6 gap-4 border-b-2 border-black pb-0.5 w-full'>
            <p>User</p>
            <p>Date/Time</p>
            <p>Action</p> 
            <p>Component type</p>
          ...
          {activities.length > 0 ? (
            ...
            <div className='flex flex-col justify-center mb-[1rem] items-center mt-[5rem]'>
              <MagnifyingGlassIcon className="h-5 w-5" />
              <h1 className='text-2xl mb-3'>No activity log found</h1>
